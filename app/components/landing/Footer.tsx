...
const Footer = () => {
  ...
  return (
    <footer className="relative bg-[#030712] border-t border-white/[0.05] selection:bg-indigo-500/30">
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <motion.button
            onClick={scrollToTop}
            whileHover={{ y: -5 }}
            className="p-4 bg-white/[0.02] border border-white/[0.05] rounded-2xl text-white hover:bg-indigo-600 transition-all group shadow-xl"
        ...
        <div className="mt-12 pt-8 border-t border-white/[0.05] flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-gray-600 uppercase tracking-widest">
          ...
          <p className="flex items-center gap-1.5">
            Designed & Built with <Heart size={10} className="text-indigo-500 fill-indigo-500" /> by NS
          </p>
        </div>
      </div>
    </footer>
